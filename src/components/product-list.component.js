...
import { fetchObjects, deleteObjects } from "../redux/actions";
...
//   const getData = () => {
//     axios.get(`http://localhost:5000/product/`).then((getData) => {
...
//   };
  ...
  const setData = (data) => {
    ...
    console.log(
      "Product Name is :" + localStorage.setItem("ProductName", productName)
    );
  };
  ...
  const searchItems = (searchValue) => {
    ...
    if (searchInput !== "") {
      const filteredData = objects.filter((data) => {
                                ...
                                <td className="px-6 py-4">
                                  <div class="flex justify-center">
                                    <div class="ml-2">
                                      <Link to="/editProduct">
                                        <button
                                          className="inline-flex items-center text-sm font-medium text-black duration-300 rounded-full hover:bg-yellow-100"
