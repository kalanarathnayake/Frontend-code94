...
export default function ProductList() {
    ...
    const setData = (data) => {
        let { _id, sku, quantity, productName, imgUrl, productDescription, isFavourite, price } = data;
        ...
        //check payload
        console.log("ID is :" + localStorage.setItem('Id', _id));
                                            ...
                                            <div class="grid grid-cols-2 gap-4 form-group">
                                                <form class=" " >
                                                    <div class=" flex flex-row justify-between">
                                                        ...
                                                        />
                                                        <div className="flex px-5 py-1 text-center text-white align-middle rounded-full max- form-group" style={{ backgroundColor: "#001EB9" }}>
                                                            <svg class="h-5 w-5 mr-2 mt-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                                                <path fillRule="evenodd" d="M10.5 3.75a6.75 6.75 0 100 13.5 6.75 6.75 0 000-13.5zM2.25 10.5a8.25 8.25 0 1114.59 5.28l4.69 4.69a.75.75 0 11-1.06 1.06l-4.69-4.69A8.25 8.25 0 012.25 10.5z" clipRule="evenodd" />
                                                            </svg>

                                                            <input className='text-white' type="submit" value="Search" />
                                                        </div>
                                                    </div>
                                                </form>
                                            </div>
                            ...
                            <div className='relative grid content-start grid-cols-1 gap-4 px-10 overflow-x-auto shadow-md sm:rounded-lg'>
                                <table className='w-full text-sm text-left text-gray-500 dark:text-gray-400'>
                                    <thead className='p-5 text-base uppercase dark:bg-gray-700 dark:text-gray-400'>
                                        <tr>
                                            <th className="pl-6 font-bold tbhead" style={{ color: "#001EB9" }}>SKU</th>
                                            <th className="pl-6 tbhead" style={{ color: "#001EB9" }}>Image</th>
                                            <th className="pl-6 tbhead" style={{ color: "#001EB9" }}>Product Name</th>
                                            <th className="pl-6 tbhead" style={{ color: "#001EB9" }}>Price</th>
                                            <th className="pl-6 tbhead" style={{ color: "#001EB9" }}></th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        {/* search list */}
                                        {searchInput.length > 1 ? (
                                            filteredResults.map((data) => {
                                                if (searchInput === data.sku) {
                                                    return (
                                                        <tr className='bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600'>
                                                            <td className='py-4 pl-6 text-base'>{data.sku}</td>
                                                            <td className='px-6 py-4'>{data.imgUrl}</td>
                                                    ...
                                                    <tr className='bg-transparent border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600'>
                                                        ...
                                                        <td className='px-6 py-4'>
                                                            <div class="flex justify-center">
                                                                ...
                                                                <div class="ml-2">
                                                                    <Link to='/editProduct'>
                                                                        <button className='items-center text-sm font-medium text-black duration-300 rounded-full nline-flex hover:bg-blue-100' onClick={() => setData(data)}>
                                                                            <div class="">
                                                                                <svg class="h-5 w-5 m-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                                                                    <path d="M21.731 2.269a2.625 2.625 0 00-3.712 0l-1.157 1.157 3.712 3.712 1.157-1.157a2.625 2.625 0 000-3.712zM19.513 8.199l-3.712-3.712-12.15 12.15a5.25 5.25 0 00-1.32 2.214l-.8 2.685a.75.75 0 00.933.933l2.685-.8a5.25 5.25 0 002.214-1.32L19.513 8.2z" />
                                                                                </svg>
